...
class th0ths_Movie_Collection_Best extends WP_Widget {
    /** constructor */
    function __construct() {
        parent::WP_Widget('th0th-movie-collection-best', 'Movie Collection - Best Movies', array( 'description' => 'Movies with the highest ratings from your collection' ) );
    }
    ...
    function form($instance) {
        ...
        {
            $title = __( 'Best Movies', 'text_domain' );
            $number_of_movies = 1;
        }
        ?>
        <p>
    ...
    function _sort_movies_by_rating($a, $b)
    {
...
add_action('widgets_init', create_function('', 'return register_widget("th0ths_Movie_Collection_Best");'));
